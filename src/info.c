...
const unsigned char GET_WAN_MAC[]="echo 22:22:22:22:22:22"; // 获取wan口MAC地址
const unsigned char GET_WAN_IP[]="echo 102.0.0.1"; // 获取wan口IP地址
const unsigned char GET_WAN_NETMASK[]="echo 255.255.255.0"; // 获取wan口netmask
const unsigned char GET_WAN_GATEWAY[]="echo 102.0.0.1"; // 获取wan口网关地址
...
const unsigned char GET_DEBUG[]="echo 1"; // DEBUG开关
/* 静态常量*/
